...
const Header: React.FC = () => {
    ...
    return (
        <>
            ...
            <div
                ref={refMenuMobile}
                className="bg-white/95 mt-12 fixed lg:hidden right-0 left-0 bottom-0 top-10 dark:bg-zinc-900/95 z-100 items-center flex  flex-col gap-y-4 text-gray-500 fill-gray-500 text-sm"
            >
